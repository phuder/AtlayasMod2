...
//	{
//		public static LocalizedText SelsaOrePassMessage { get; private set; }
//		public static LocalizedText BlessedWithSelsaOreMessage { get; private set; }

//		public override void SetStaticDefaults() {
//			SelsaOrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(SelsaOrePassMessage)}");
//			BlessedWithSelsaOreMessage = Mod.GetLocalization($"WorldGen.{nameof(BlessedWithSelsaOreMessage)}");
//		}
...
//					Main.NewText(BlessedWithSelsaOreMessage.Value, 50, 255, 130);
//				}
//				else if (Main.netMode == NetmodeID.Server) {
//					ChatHelper.BroadcastChatMessage(BlessedWithSelsaOreMessage.ToNetworkText(), new Color(50, 255, 130));
//				}
...
//				tasks.Insert(ShiniesIndex + 1, new SelsaOrePass("Atlayas Mod Ores", 237.4298f));
//			}
//		}
//	}

//	public class SelsaOrePass : GenPass
//	{
//		public SelsaOrePass(string name, float loadWeight) : base(name, loadWeight) {
//		}
...
//			progress.Message = SelsaOreSystem.SelsaOrePassMessage.Value;
...
//				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<SelsaOre>());
