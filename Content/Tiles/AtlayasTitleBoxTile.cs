...
{
	// See AtlayasMod/Common/Systems/MusicLoadingSystem for an explanation on music.
	public class AtlayasTitleBoxTile : ModTile
	{
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<AtlayasTitleBox>();
		}
