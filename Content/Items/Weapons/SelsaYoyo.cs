...
{
    public class SelsaYoyo : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SelsaYoyoProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<SelsaBar>())
