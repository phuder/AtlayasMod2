...
{
	public class AtlayasTitleBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Atlayas"), ModContent.ItemType<AtlayasTitleBox>(), ModContent.TileType<AtlayasTitleBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<AtlayasTitleBoxTile>(), 0);
		}
	}
}
