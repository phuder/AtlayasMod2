...
{
    public class SelsaYoyoProjectile : ModProjectile
    {
        ...
        public override void PostAI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.WhiteTorch); // Makes the projectile emit dust.
            }
        }
    }
}